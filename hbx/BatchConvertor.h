...
#ifndef HBX_BATCHCONVERTOR_H
#define HBX_BATCHCONVERTOR_H 1

#include <hbx/ActionQueue.h>
#include <hbx/FileOutputAction.h>
#include <hbx/FileInputAction.h>

namespace hbx {

class BatchConvertor;

class HBX_EXPORT ProcessingInputCallback : public virtual osg::Referenced
{
public:
...
class HBX_EXPORT BatchConvertor : public osg::Referenced
{
public:
    ...
    {
        hbx::FileInputAction* inputOp = new hbx::FileInputAction();
