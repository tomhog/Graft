...
static bool checkChildren( const hbx::ActionQueue& aQueue )
{
    return aQueue.getNumActions()>0;
}

static bool readChildren( osgDB::InputStream& is, hbx::ActionQueue& aQueue )
{
    unsigned int size = 0; is >> size >> is.BEGIN_BRACKET;
    for ( unsigned int i=0; i<size; ++i )
    {
        osg::ref_ptr<osg::Object> obj = is.readObject();
        hbx::Action* child = dynamic_cast<hbx::Action*>( obj.get() );
...
static bool writeChildren( osgDB::OutputStream& os, const hbx::ActionQueue& aQueue )
{
...
REGISTER_OBJECT_WRAPPER( hgx_ActionQueue,
                         new hbx::ActionQueue,
                         hbx::ActionQueue,
                         "osg::Object hbx::ActionQueue" )
{
