...
#ifndef HBX_CHANGEFILEEXTENSIONACTION_H
#define HBX_CHANGEFILEEXTENSIONACTION_H 1
...
//
class HBX_EXPORT ChangeFileExtensionAction : public Action
{
public:
    ...
    META_Object(hbx,ChangeFileExtensionAction)
...
#endif // HBX_CHANGEFILEEXTENSIONACTION_H
