...
//
int hbx::getNumElementsForType(osgDB::BaseSerializer::Type aType)
{
    switch(aType)
    {
...
//
bool hbx::getPropertyAsString(osg::Object* anObject, const std::string& aPropertyName, std::string& aValueString)
{
    ...
    switch(type)
    {
        ...
        case osgDB::BaseSerializer::RW_VEC2F:
        {
            ...
            for(int i=0; i<hbx::getNumElementsForType(type); i++)
...
//
bool hbx::setPropertyFromString(osg::Object* anObject, const std::string& aPropertyName, const std::string& aValueString)
{
    osgDB::ClassInterface ci;
    osgDB::BaseSerializer::Type type;
    if(!ci.getPropertyType(anObject, aPropertyName, type))
...
//
//
bool hbx::getPropertyAsStringVector(osg::Object* anObject, const std::string& aPropertyName, std::vector<std::string>& aStringVector)
{
    osgDB::ClassInterface ci;
    osgDB::BaseSerializer::Type type;
    if(!ci.getPropertyType(anObject, aPropertyName, type))
...
bool hbx::setPropertyFromStringVector(osg::Object* anObject, const std::string& aPropertyName, const std::vector<std::string>& aStringVector)
{
    osgDB::ClassInterface ci;
    osgDB::BaseSerializer::Type type;
    if(!ci.getPropertyType(anObject, aPropertyName, type))
