...
#ifndef HBX_FORMATS_H
#define HBX_FORMATS_H 1
...
extern HBX_EXPORT void getAllSupportedFilesInFolder(const std::string& aFolder, osgDB::FilePathList& allFiles, bool recurseSubFolders = false);


//
// Helper class to get information about formats supported by available osgPlugins
//
class HBX_EXPORT Formats : public osg::Referenced
{
public:
