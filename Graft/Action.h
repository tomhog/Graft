...
#ifndef GRAFT_ACTIONS_H
#define GRAFT_ACTIONS_H 1
...
class GRAFT_EXPORT ActionData : public osg::Referenced
{
public:
...
//
class GRAFT_EXPORT Action : public osg::Object
{
public:
    Action()
     : osg::Object(),
...
//
class GRAFT_EXPORT InputAction : public Action
{
public:
    InputAction() : Action() {}
...
//
class GRAFT_EXPORT OutputAction : public Action
{
public:
    OutputAction() : Action() {}
...
//
class GRAFT_EXPORT VisitorAction : public Action
{
public:
