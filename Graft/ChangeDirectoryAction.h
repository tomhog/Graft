...
#ifndef GRAFT_CHANGEDIRECTORYACTION_H
#define GRAFT_CHANGEDIRECTORYACTION_H 1
...
//
class GRAFT_EXPORT ChangeDirectoryAction : public Action
{
public:
    ...
    META_Object(graft,ChangeDirectoryAction)
...
#endif // GRAFT_CHANGEDIRECTORYACTION_H
