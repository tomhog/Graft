...
#ifndef GRAFT_FILEINPUTACTION_H
#define GRAFT_FILEINPUTACTION_H 1
...
//
class GRAFT_EXPORT FileInputAction : public InputAction
{
public:
    ...
    META_Object(graft,FileInputAction)
