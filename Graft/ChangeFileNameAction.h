...
#ifndef GRAFT_CHANGEFILENAMEACTION_H
#define GRAFT_CHANGEFILENAMEACTION_H 1
...
//
class GRAFT_EXPORT ChangeFileNameAction : public Action
{
public:
    ...
    META_Object(graft,ChangeFileNameAction)
...
#endif // GRAFT_CHANGEFILENAMEACTION_H
