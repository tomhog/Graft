...
#define GRAFT_CONFIG_PATH "./config"
#define GRAFT_CONFIG_FILE "config.osgt"

namespace graft {

class GRAFT_EXPORT ConfigObject : public osg::Object
{
public:
    ConfigObject()
        : osg::Object(),
    ...
    META_Object(graft,ConfigObject)
...
//
class GRAFT_EXPORT Config : public osg::Referenced
{
public:
    ...
    bool read()
    {
        ...
        std::string configFilePath = std::string(GRAFT_CONFIG_PATH) + "/" + std::string(GRAFT_CONFIG_FILE);
    ...
    bool write()
    {
        ...
        std::string configPath = std::string(GRAFT_CONFIG_PATH);
        std::string configFilePath = std::string(GRAFT_CONFIG_PATH) + "/" + std::string(GRAFT_CONFIG_FILE);
