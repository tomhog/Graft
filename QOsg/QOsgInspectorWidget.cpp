#include <QOsg/QOsgInspectorWidget.h>

#include "QOsgPropertyWidgets.h"

QOsgInspectorWidget::QOsgInspectorWidget(QWidget *parent) : QScrollArea(parent)
{
...
void QOsgInspectorWidget::clearLayout(QLayout* layout, bool deleteWidgets)
{
